 ...
 * XEN: The codes above 0x58 are produced by linux input events.
 */
Rune kbtab[Nscan] = 
{
...
[0x28]	'\'',	'`',	Kshift,	'\\',	'z',	'x',	'c',	'v',
[0x30]	'b',	'n',	'm',	',',	'.',	'/',	Kshift,	'*',
[0x38]	Kalt,	' ',	Kcaps,	KF|1,	KF|2,	KF|3,	KF|4,	KF|5,
[0x40]	KF|6,	KF|7,	KF|8,	KF|9,	KF|10,	Knum,	Kscroll,'7',
[0x48]	'8',	'9',	'-',	'4',	'5',	'6',	'+',	'1',
[0x50]	'2',	'3',	'0',	'.',	0,	0,	0,	KF|11,
[0x58]	KF|12,	0,	0,	0,	0,	0,	0,	0,
[0x60]	'\n',	Kctl,	'/',	0,	Kalt,	0,	Khome,	Kup,
[0x68]	Kpgup,	Kleft,	Kright,	Kend,	Kdown,	Kpgdown,	Kins,	Kdel,
[0x70]	0,	0,	0,	0,	0,	'=',	0,	0,
